 ...
 */
function useKorapay(monoConfig) {
    var _a = useMonoScript(), loaded = _a[0], error = _a[1];
    react.useEffect(function () {
        if (error) {
    ...
    function handleMono(_a) {
        ...
        if (loaded) {
            ...
            // @ts-ignore
            var connect = new window.Connect(monoConfig.public_key, {
                onSuccess: onSuccess,
                onClose: onClose,
            });
            connect.setup();
...
var MonoButton = function (_a) {
    ...
    var handleMono = useKorapay(config);
    return (react.createElement("button", { disabled: disabled, className: className, onClick: function () { return handleMono({ onSuccess: onSuccess, onClose: onClose }); } }, text || children));
};

exports.MonoButton = MonoButton;
exports.useMono = useKorapay;
